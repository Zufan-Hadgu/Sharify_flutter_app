...
//   return GetAdminItemsUseCase(ref.watch(adminRepositoryProvider)); // ✅ Uses correct repository
// });
//
// // final getItemsUseCaseProvider = Provider((ref) => GetItemsUseCase(ref.watch(adminRepositoryProvider)));
